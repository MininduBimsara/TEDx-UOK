...
/**
 * Parses a string and replaces occurrences of TEDx brand variants
 ...
 */
export function formatTedxText(
  ...
  const parts = text.split(
    /(TEDx University of Kelaniya|TEDx UoK|TEDxUoK|TEDx UOK|TEDxUOK|TEDx)\b/g,
  );
    ...
    <>
      {parts.map((part, index) => {
        if (
          ...
          const brandSuffix = isFullUniversity
          ...
          return (
            <span key={index} className={isTopic ? "font-extrabold" : ""}>
              ...
              <span className="font-normal text-inherit">{brandSuffix}</span>
            </span>
          );
        }
        if (part === "TEDx") {
