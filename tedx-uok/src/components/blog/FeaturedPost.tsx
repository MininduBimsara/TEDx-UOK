...
export function FeaturedPost({ post }: FeaturedPostProps) {
  ...
  return (
    ...
    >
      ...
      <Link
        to={`/blog/${post.slug}`}
        className="block group overflow-hidden rounded-3xl relative aspect-[4/3] lg:aspect-auto lg:h-[600px] w-full"
      >
        {post.cover_image_url ? (
          ...
          <div className="w-full h-full bg-[#1a1a1a] flex items-center justify-center">
            <span className="text-white/20 font-bold text-xl">TEDxUoK</span>
          </div>
        )}
