          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              {description ? (
                ...
                formatTedxText("TEDx UoK brings together thought leaders, innovators, and change-makers to share ideas worth spreading. Join us for a day of inspiring talks, meaningful connections, and transformative experiences.")
              )}
            </p>
            ...
            <Link to="/about">
              <Button variant="tedxSecondary" size="lg">
                {formatTedxText("Learn More About TEDx")}
