      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto px-2">
            In the spirit of ideas worth spreading, TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup> is a program of local, self-organized events that bring people together to share a TED-like experience.
          </p>
        </div>

        {/* Definition Section */}
        <div className="mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-6 md:mb-8 text-center md:text-left">What is TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup> ?</h2>
          <div className="bg-card border border-border rounded-lg p-6 md:p-8">
            <p className="text-xl text-muted-foreground">
              TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup> events are independently organized under a free license granted by TED.
        ...
        {/* TED vs TEDx */}
        <div className="mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-6 md:mb-8 text-center">TED vs TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup></h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* TEDx */}
            <div className="bg-card border border-border rounded-lg p-8">
              <h3 className="text-3xl font-bold text-primary mb-6">TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup></h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-primary mr-2">•</span>
        ...
        <div className="mb-16">
          ...
          <div className="bg-card border border-border rounded-lg p-6 md:p-8">
            <p className="text-xl text-muted-foreground mb-6">
              TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup> events are operated under license from TED. Organizers agree to follow strict guidelines to ensure quality and consistency with TED values.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-primary mr-2" />
                    <span className="text-muted-foreground">Official TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup> branding</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-primary mr-2" />
        ...
        <div className="text-center">
          ...
          >
            Learn About Organizing TED<sup className="uppercase" style={{ fontSize: '0.7em', top: '-0.3em', position: 'relative' }}>x</sup>
