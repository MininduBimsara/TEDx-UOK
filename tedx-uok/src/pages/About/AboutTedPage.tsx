  ...
  return (
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        {/* Mission Section */}
        <div className="mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-6 md:mb-8 text-center md:text-left">{aboutTedContent.title}</h2>
          <div className="bg-card border border-border rounded-lg p-6 md:p-8">
            {aboutTedContent.paragraphs.map((para, index) => (
              <p
                key={index}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {historyContent.items.map((item, index) => {
              const yearText = item.year.includes(" - ") ? item.year.split(" - ")[0] : item.year;
              const headingText = (item as any).heading || (item.year.includes(" - ") ? item.year.split(" - ")[1] : "");
              
              return (
                <div key={index} className="bg-card border border-border rounded-lg p-6">
                  <div className="text-primary text-3xl font-bold mb-4">{yearText}</div>
                  <h3 className="text-xl font-bold text-foreground mb-3">{headingText}</h3>
